...
import { Calendar as CalendarIcon, Plane, Hash, FileText, Activity } from "lucide-react"
      ...
      <DialogContent className="sm:max-w-[500px] overflow-hidden">
        ...
        <form onSubmit={create} className="space-y-6 mt-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="name" name="name" required className="pl-10" placeholder="Nhập tên thiết bị" />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="code" name="code" required className="pl-10" placeholder="Nhập mã code" />
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            <Label htmlFor="activity" className="text-sm font-medium flex items-center">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Textarea id="note" name="note" className="pl-10" placeholder="Nhập ghi chú (nếu có)" />
            </div>
          </div>

          <Button type="submit" className="w-full bg-gradient-to-r from-black to-gray-600 hover:from-black hover:to-gray-700 text-white">
            Thêm Thiết Bị
          </Button>
        </form>
      </DialogContent>
